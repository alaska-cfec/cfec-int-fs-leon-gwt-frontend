...
/**
 * ArenewPermits generated by hbm2java
 */
@SuppressWarnings({ "serial", "rawtypes"})
public class ArenewPermits implements Serializable, Comparable {
	...
	public int compareTo(Object padd) {
		ArenewPermits pmt = null;
		try {
		pmt = (ArenewPermits) padd;
		/*
