...
/**
 * ArenewVessels generated by hbm2java
 */
@SuppressWarnings({ "serial", "rawtypes"})
public class ArenewVessels implements Serializable, Comparable {
	...
	public int compareTo(Object vadd) {
		ArenewVessels ves = null;
		try {
		ves = (ArenewVessels) vadd;
		/*
